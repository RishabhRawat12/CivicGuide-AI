...
export default function DashboardLayout() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-bg-dark transition-colors duration-500">
      ...
      <header className="sticky top-0 z-40 bg-bg-card/80 backdrop-blur-xl border-b border-border shadow-sm px-4 lg:px-6 flex-shrink-0 transition-colors duration-500">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-bg-elevated flex items-center justify-center text-lg shadow-md shadow-primary/20" role="img" aria-label="CivicGuide Logo">
              🗳️
            </div>
            <div className="hidden sm:block">
              <p className="text-base font-bold text-primary leading-tight">CivicGuide AI</p>
              <p className="text-[10px] text-text-muted leading-tight font-medium uppercase tracking-wider">Election Commission</p>
            </div>
          </div>

          {/* Center: Desktop Navigation Links */}
          <nav className="hidden lg:flex flex-1 justify-center items-center px-8 space-x-1" aria-label="Main Navigation">
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={toggleTheme} 
              className="p-2 rounded-lg text-text-muted hover:bg-bg-elevated hover:text-accent transition-colors focus-visible:ring-2 focus-visible:ring-primary" 
            ...
            <div className="hidden md:flex items-center gap-3 pl-2 border-l border-border ml-1">
              ...
              <NavLink to="/dashboard/profile" className="hover:opacity-80 transition-opacity" aria-label="Go to profile">
                <UserAvatar />
              </NavLink>
      ...
      {/* ====== MAIN CONTENT ====== */}
      <main className="flex-1 overflow-y-auto w-full relative" id="main-content" role="main" tabIndex="-1">
            ...
            >
              ...
              <div className="px-5 py-4 flex items-center justify-between">
                <motion.div
                  ...
                  <div className="w-10 h-10 rounded-xl bg-bg-elevated flex items-center justify-center text-lg shadow-md" role="img" aria-label="Logo">
                    🗳️
                  </div>
                  <div>
                    <p className="text-sm font-bold text-primary leading-tight">CivicGuide</p>
