/**
 * @fileoverview Single Source of Truth for Electoral Scenarios
 * Ported from legacy server/controllers/scenarioController.js
 */

const FALLBACK_SCENARIOS = {
  first_time_voter: {
    scenario: 'first_time_voter',
    ...
    helplineNumber: '1950',
    nextAction: 'Start registration at voters.eci.gov.in',
  },
  lost_voter_id: {
    scenario: 'lost_voter_id',
    title: 'Lost Voter ID — Get a Replacement',
    icon: '🔍',
    ...
    helplineNumber: '1950',
    nextAction: 'Visit voters.eci.gov.in and apply for duplicate',
  },
  name_mismatch: {
    scenario: 'name_mismatch',
    title: 'Name Mismatch in Voter Records',
    icon: '✏️',
    ...
    estimatedTime: '15-30 days',
    helplineNumber: '1950',
    nextAction: 'Fill Form 8 on NVSP portal',
  },
  nri_voting: {
    scenario: 'nri_voting',
    title: 'NRI / Overseas Voter',
    icon: '✈️',
    description: 'Registration for citizens abroad to vote in India.',
    steps: [
    ...
    helplineNumber: '1950',
    nextAction: 'Fill Form 6A on NVSP portal',
  },
  pwd_voting: {
    scenario: 'pwd_voting',
    title: 'Voting with a Disability (PwD)',
    icon: '♿',
    ...
    helplineNumber: '1950',
    nextAction: 'Download the Saksham ECI App',
  },
  shift_constituency: {
    scenario: 'shift_constituency',
    title: 'Changing Constituency',
    icon: '🏠',
    ...
    estimatedTime: '15-30 days',
    helplineNumber: '1950',
    nextAction: 'Fill Form 8 for Shifting',
  },
  aadhaar_link: {
    scenario: 'aadhaar_link',
    ...
    helplineNumber: '1950',
    nextAction: 'Submit Form 6B online',
  },
  missed_registration: {
    scenario: 'missed_registration',
    ...
    estimatedTime: 'Next revision cycle',
    helplineNumber: '1950',
    nextAction: 'Submit Form 6 immediately',
  },
  no_documents: {
    scenario: 'no_documents',
    title: 'Voting Without Standard Documents',
    icon: '📄',
    ...
    helplineNumber: '1950',
    nextAction: 'Gather any available photo ID before election day',
  },
  senior_citizen_voting: {
    scenario: 'senior_citizen_voting',
    title: 'Senior Citizen Voting (80+)',
    icon: '👴',
    ...
    estimatedTime: '5 days after notification',
    helplineNumber: '1950',
    nextAction: 'Contact your BLO after election is announced',
  },
  voter_id_correction: {
    scenario: 'voter_id_correction',
    title: 'Correcting Voter ID Details',
    icon: '🛠️',
    ...
    estimatedTime: '15-30 days',
    helplineNumber: '1950',
    nextAction: 'Submit Form 8 with correct documents',
  },
  election_day_guide: {
    scenario: 'election_day_guide',
    ...
    helplineNumber: '1950',
    nextAction: 'Find your booth location beforehand',
  },
  postal_ballot: {
    scenario: 'postal_ballot',
    title: 'Postal Ballot',
    icon: '📮',
    ...
    estimatedTime: 'Within notification period',
    helplineNumber: '1950',
    nextAction: 'Apply after election notification',
  },
  voter_list_deletion: {
    scenario: 'voter_list_deletion',
    title: 'Name Deleted',
    icon: '❌',
    ...
    estimatedTime: '15-30 days',
    helplineNumber: '1950',
    nextAction: 'Search your name and re-register immediately',
  },
  complaint_filing: {
    scenario: 'complaint_filing',
    ...
    estimatedTime: 'Action within 100 minutes',
    helplineNumber: '1950',
    nextAction: 'Install cVIGIL from your app store',
  },
  evm_vvpat_info: {
    scenario: 'evm_vvpat_info',
    title: 'EVM & VVPAT',
    icon: '🖥️',
    ...
    documentsNeeded: [],
    estimatedTime: 'Educational — no action needed',
    helplineNumber: '1950',
    nextAction: 'Watch ECI\'s EVM demo video',
  },
  model_code_conduct: {
    scenario: 'model_code_conduct',
    ...
    documentsNeeded: [],
    estimatedTime: 'Educational',
    helplineNumber: '1950',
    nextAction: 'Learn your rights as a voter',
  },
  multiple_entries: {
    scenario: 'multiple_entries',
    ...
    estimatedTime: '15-30 days',
    helplineNumber: '1950',
    nextAction: 'File Form 7 on NVSP portal',
  },
  overseas_voting_bill: {
    scenario: 'overseas_voting_bill',
    title: 'NRI Remote Voting',
    icon: '🌍',
    ...
    estimatedTime: 'Pending legislation',
    helplineNumber: '1950',
    nextAction: 'Register as Overseas Elector now',
  },
  transgender_voter: {
    scenario: 'transgender_voter',
    title: 'Transgender Voter',
    icon: '🏳️‍🌈',
    ...
    estimatedTime: '15-30 days',
    helplineNumber: '1950',
    nextAction: 'Register using Form 6 with third gender option',
  },
};

module.exports = { FALLBACK_SCENARIOS };
